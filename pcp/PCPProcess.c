...
const ProcessFieldData Process_fields[] = {
   ...
   [COMM] = { .name = "Command", .title = "     Name ", .description = "Command line", .flags = 0, },
   [STATE] = { .name = "STATE", .title = "S ", .description = "Process state (S sleeping, R running, D disk, Z zombie, T traced, W paging, I idle)", .flags = 0, },
   [PPID] = { .name = "PPID", .title = "PPID", .description = "Parent process ID", .flags = 0, },
   [MYCGROUP] = { .name = "MYCGROUP", .title = " User ", .description = "=========================", .flags = 0, },
   [MYCGROUP1] = { .name = "MYCGROUP1", .title = "System ", .description = "=========================", .flags = 0, },
   [MYCGROUP2] = { .name = "MYCGROUP2", .title = "Usage ", .description = "=========================", .flags = 0, },
